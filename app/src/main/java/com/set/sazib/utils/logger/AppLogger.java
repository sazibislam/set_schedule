...
public final class AppLogger {
  ...
  public static void printer(@NonNull Printer printer) {
    AppLogger.printer = LogUtils.checkNotNull(printer);
  }

  public static void addLogAdapter(@NonNull LogAdapter adapter) {
    printer.addAdapter(LogUtils.checkNotNull(adapter));
  }
  ...
  public static void init() {
    ...
    AppLogger.addLogAdapter(new AndroidLogAdapter(formatStrategy) {
      @Override
